...
<h1 class = "home-header"> SimpleLearn</h1><br><br>
					...
					<div class="content-row">
						<div class="panel back-color-white">
							<div class="panel-header-norm">
								<h2 style = "color: white;">New Instructor</h2>
							</div>
							<div class="panel-content-norm">
								<span class="error" id="error"></span>
								<form class="enter-data" method="post" id="setInstructor">
									<div>
		...
		<script type="text/javascript">document.getElementById('setInstructor').addEventListener('submit', setInstructor);</script>
